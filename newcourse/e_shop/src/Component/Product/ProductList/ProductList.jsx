...
import {FILTER_BY_SEARCH,selectFilterProductis,SORT_PRODUCT}    from "../../../redux/slice/filterSlice"
  ...
  return (
    ...
    <div className={styles.top}>
      <div className={styles.icons}>
        ...
        <p><b>{FilterselectProduct.length}</b> products found</p>
      </div>
      ...
      <div className={grid?`${styles.grid}`:`${styles.list}`}>
        {
         ...
         :(
          <>
          {FilterselectProduct.map((product)=>{
           return (
             //{...product}
          <div key={product.id}>
